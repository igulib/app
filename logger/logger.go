...
func Create(config *Config) error { // , hooks ...zerolog.Hook
...
func (u *appLogger) init(c *Config) error { // , hooks ...zerolog.Hook
...
// RegisterHooks allows to register zerolog.Hook
// objects for advanced message processing, see igulib/telegram_notifier
// as an example.
